...
<body>
   ...
   <!--======================================== 
    ...
    <br>
     ...
     <section style="margin-left: -10px;background-image: url('assets/img/health.jpg')!important;">
    ...
    <?php if(isset($_SESSION['id'])) 
    {
        ...
        ?>
        <br/>
        <h1 style="text-align: center; font-weight:bold;color: #33ffff;">Health</h1>
        <h5 style="text-align: center; font-weight:bold;color: #33ffff;">What about the using of 3d printer in the Health industry ?</h5>
        <br>
        <?php
    ...
    <section style="margin : 50px;">
        ...
        $reponse = $bdd->query('SELECT member.nickname, forum.message, forum.date FROM forum, member where member.id = forum.id_user and id_topic=5 ORDER BY date DESC LIMIT 0, 10');
