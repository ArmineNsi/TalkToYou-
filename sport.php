...
<body>
   ...
   <!--======================================== 
    ...
    <nav class="navbar navbar-default navbar-fixed white no-background bootsnav navbar-scrollspy" data-minus-value-desktop="70" data-minus-value-mobile="55" data-speed="1000" style="background-color:black;">
    ...
    <section style="margin-left: -10px;background-image: url('assets/img/sport3.jpg')!important;background-size: cover;">

    <?php if(isset($_SESSION['id'])) 
    {
        ?>
        <br>
        <h1 style="text-align: center; color: #66d9ff;">Sport</h1>
        <h5 style="text-align: center;color: #66d9ff;"> What do you think about the new Ballon d'or Luka Modric ?</h5>
        <br>
        ...
        if (isset($_POST['message']) ) { 
            ...
            if(strlen($_POST['message'])>=3)
            {
                ...
                ?>
                <p style="text-align:center;color: #66d9ff;">Your message must have 3 characters at least.</p>
            ...
            ?> 
            <p style="text-align:center;color: #66d9ff;">
    ...
    <section style="margin : 50px;">
        ...
        $reponse = $bdd->query('SELECT member.nickname, forum.message, forum.date FROM forum, member where member.id = forum.id_user and id_topic=1 ORDER BY date DESC LIMIT 0, 10');

        // Affichage de chaque message (toutes les données sont protégées par htmlspecialchars)
        while ($donnees = $reponse->fetch())
        {
            echo '<p class="messagepost"><strong>' . htmlspecialchars($donnees['nickname']) . '</strong> :<br>' . htmlspecialchars($donnees['message']) . '<br>' . htmlspecialchars($donnees['date']) . '</p>';
        }
