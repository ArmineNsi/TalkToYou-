...
<body>
   ...
   <!--======================================== 
    ...
    <nav class="navbar navbar-default navbar-fixed white no-background bootsnav navbar-scrollspy" data-minus-value-desktop="70" data-minus-value-mobile="55" data-speed="1000" style="background-color: #660022;">
    ...
    <section style="margin-left: -10px;background-image: url('assets/img/cinema2.jpg')!important; background-size: cover;">
     ...
     <?php if(isset($_SESSION['id'])) 
    {
        ...
        <br>
        <h1 style="text-align: center;font-weight: bold; color: #660022;">Cinema</h1>
        <h5 style="text-align: center;font-weight: bold;color: #660022;">What was the worst film in 2018 ?</h5>
        <br>
        ...
        if (isset($_POST['message']) ) { 
            ...
            if(strlen($_POST['message'])>=3)
            {
                ...
                ?>
                <p style="text-align:center;color: #660022;">Your message must have 3 characters at least.</p>
            ...
            ?> 
            <p style="text-align:center;color: #660022;">
    ...
    <section style="margin : 50px;">
        ...
        $reponse = $bdd->query('SELECT member.nickname, forum.message, forum.date FROM forum, member where member.id = forum.id_user and id_topic=4 ORDER BY date DESC LIMIT 0, 10');
