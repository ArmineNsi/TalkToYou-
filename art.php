...
<body>
   ...
   <!--======================================== 
    ...
    <nav class="navbar navbar-default navbar-fixed white no-background bootsnav navbar-scrollspy" data-minus-value-desktop="70" data-minus-value-mobile="55" data-speed="1000" style="background-color: #ffff00;">
    ...
    <section style="margin-left: -10px;background-image: url('assets/img/art2.jpg')!important;">
    ...
    <?php if(isset($_SESSION['id'])) 
    {
        ...
        <br/>
        <h1 style="text-align: center; font-weight:bold ; color: #ffff00;">Art</h1>
        <h5 style="text-align: center; font-weight:bold ; color: #ffff00;">Does Senegal have to take back its art from European Museaum ?</h5>
        <br>
        ...
        if (isset($_POST['message']) ) { 
            ...
            if(strlen($_POST['message'])>=3)
            {
                ...
                ?>
                <p style="text-align:center; font-weight:bold; color: #ffff00;">Your message must have 3 characters at least.</p>
            ...
            ?> 
            <p style="text-align:center; font-weight:bold;color: #ffff00;">
    ...
    <section style="margin : 50px;">
        ...
        $reponse = $bdd->query('SELECT member.nickname, forum.message, forum.date FROM forum, member where member.id = forum.id_user and id_topic=2 ORDER BY date DESC LIMIT 0, 10');
